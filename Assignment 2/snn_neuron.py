...
class LIFFCLayer(object):
    def __init__(self, n_input, n_neuron, \
                delta_t = 1.0, resistance = 10.0, conductance = 2.0, refact_time = 2,\
...
#         self.synapses = W / scale
        ...
        # Resting potential is set to 0
        # self.Vrest = np.zeros(n_neuron)
        # Resistance
        self.Rm = resistance
        # Conductance
        self.Cm = conductance
    ...
    def forward_step(self, features):
        ...
        """
        # new input spikes are mapped to through synapses
        inputVec = np.matmul(features, self.synapses)
        # previous currents leave traces
        inputVec += self.inVec * self.inDecay
        self.inVec = inputVec
...
#         print("neuron potential: " + str(self.Vm))
        ...
        # debug
#         print("input: " + str(I))
#         print("potential update: " + str(diff))
#         print("updated neuron potential: " + str(self.Vm))
#         print("fired neurons: " + str(firedNeurons))
#         print("count down: " + str(self.refCtDwn))
#         input()
